...
class Example extends React.Component {
  constructor(props) {
    ...
    this.updateMottoBound = event => this.updateMotto(event);
  }
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          ...
          <h3 className="motto-style">{this.state.name}'s motto: {this.state.motto}</h3>
          <label htmlFor="mottoIn">Update Moto: </label>
          <input id="mottoIn" type="text" value={this.state.motto} onChange={this.updateMottoBound} />
        </div>
